...
export async function POST(request: Request) {
  ...
  const context = {
    ...
    preferences: { activityLevel: profile.activity, workoutsPerWeek: profile.workouts, diet: profile.diet, restrictions: profile.restrictions || "אין מגבלות מתועדות", tasteProfile: profile.tasteProfile || { status: "השאלון טרם מולא" } },
